...
DB_path = 'Database Connections\\DC_TRANSADMIN@UTRANS@utrans.agrc.utah.gov.sde'
...
##with arcpy.da.Editor(DB_path) as editor:
##    # In order to open state, add line that starts editing
##    # edit.startEditing(False, True)
##    # edit.startOperation()
