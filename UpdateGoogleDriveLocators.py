...
hnasLocators_Folder = r'M:\Team Drives\AGRC Projects\Locators'
#previousHnasLocators_Folder = 'K:/AGRC Projects/Locators/PreviousLocators'
previousHnasLocators_Folder = r'M:\Team Drives\AGRC Projects\Locators\_previousRebuild'
...
# delete all files in the backup folder
print "Deleting the folder and all the files >>> M:/Team Drives/AGRC Projects/Locators/PreviousLocators ..."
shutil.rmtree(previousHnasLocators_Folder)
# create the folder again
print "Recreating the empty directory M:/Team Drives/AGRC Projects/Locators/PreviousLocators ..."
...
print "Moving existing files in M:/Team Drives/AGRC Projects/Locators to M:/Team Drives/AGRC Projects/Locators/PreviousLocators ..."
for f in files:
    shutil.move(hnasLocators_Folder+ "/" + f, previousHnasLocators_Folder)

### Copy contents from rebuild folders to M:/Team Drives/AGRC Projects/Locators
print "Copying files from D:/Rebuild Address Locators to M:/Team Drives/AGRC Projects/Locators ..."
