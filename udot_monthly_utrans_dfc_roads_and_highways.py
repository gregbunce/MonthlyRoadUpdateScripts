...
arcpy.AddJoin_management("current_update_roads_lyr", joinField_current_roads, "output_dfc_additions_lyr", joinField_dfc)
...
arcpy.AddJoin_management("snapshot_base_roads_lyr", joinField_snapshot_roads, "output_dfc_deletions_lyr", joinField_dfc)
